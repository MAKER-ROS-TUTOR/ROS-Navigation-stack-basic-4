...
#define K_P 0.05 // P constant default 0.6
#define K_I 0.9 // I constant default 0.3
#define K_D 0.1 // D constant default 0.5

//define your robot' specs here
#define MAX_RPM 80                 // motor's maximum RPM
#define COUNTS_PER_REV 39000       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.10       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.48  // distance between left and right wheels
...
/// ENCODER PINS
/// waring if chnage motor pin a,b must chnage encoder pin a , b for left or right too
/// eg normal motor 1  A = 5    ----> if change for wheel rev direction ---> 6
///           motor 1  B = 6    ----> if change for wheel rev direction ---> 5
///           motor1_encoder_a = 19   --> change motor enoder too  --> 18
///           motor1_enocder b = 18   --> change motor encoder too --> 19
/// if test with   teleop_twist_keyboard 
/// if wheel not stop swap encoder pin a b for fix
